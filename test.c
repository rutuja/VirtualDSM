...
int main(int arg, char **argv) {
  ...
  char *otherip=argv[3];
  int mport = atoi(argv[4]);
  int oport  = atoi(argv[5]); 
  int testnumber=atoi(argv[6]);

  printf("master=%d masterip=%s otherip=%s mport =%d oport = %d \n",master, masterip, otherip,mport,oport);
//  initializeDSM(master, masterip, 20000, otherip, 20001, 10000);
  initializeDSM(master, masterip, mport, otherip, oport, 10000);
